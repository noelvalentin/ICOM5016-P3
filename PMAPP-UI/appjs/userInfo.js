angular.module('PMAPP').controller('UserInfoController', ['$http', '$log', '$scope', '$rootScope', '$location', '$routeParams',
    function($http, $log, $scope, $rootScope, $location, $routeParams) {
        ...
        this.loadUserDetails = function(){
            ...
            var reqURL = "http://localhost:5000/PhotoMessagingApp/home/users/" + uId;
