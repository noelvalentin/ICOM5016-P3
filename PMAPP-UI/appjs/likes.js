angular.module('PMAPP').controller('LikesController', ['$http', '$log', '$scope', '$rootScope', '$location','$routeParams',
    function($http, $log, $scope, $rootScope, $location,$routeParams)  {
        ...
        this.newText = "";
           ...
           this.showLikes = function(){
            ...
            var url = "http://localhost:5000/PhotoMessagingApp/home/messages/" + mid+"/likers";
            ...
            $http.get(url).then(// success call back
                ...
                // into the list of parts in the controller.
                    ...
                    thisCtrl.mLikes = response.data.Likers;
